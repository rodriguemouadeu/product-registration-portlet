...
public class PRProductWrapper implements PRProduct, ModelWrapper<PRProduct> {
	...
	*/
	...
	@Override
	public com.liferay.portal.model.CacheModel<com.inkwell.internet.producregistration.model.PRProduct> toCacheModel() {
		return _prProduct.toCacheModel();
	}

	@Override
	public com.inkwell.internet.producregistration.model.PRProduct toEscapedModel() {
		return new PRProductWrapper(_prProduct.toEscapedModel());
	}

	@Override
	public com.inkwell.internet.producregistration.model.PRProduct toUnescapedModel() {
